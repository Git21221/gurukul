...
export default defineConfig({
  ...
  define: {
    ...
    "import.meta.env.VITE_MAIN_SERVER_PORT": JSON.stringify(process.env.VITE_MAIN_SERVER_PORT),
    "import.meta.env.VITE_BRAND_SERVER_PORT": JSON.stringify(process.env.VITE_BRAND_SERVER_PORT),
    "import.meta.env.VITE_MAIN_BASE_API_PROD_URL": JSON.stringify(process.env.VITE_MAIN_BASE_API_PROD_URL),
    "import.meta.env.VITE_BRAND_BASE_API_PROD_URL": JSON.stringify(process.env.VITE_BRAND_BASE_API_PROD_URL),
  },
  css: {
    preprocessorOptions: {
      scss: {
